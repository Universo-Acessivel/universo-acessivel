        ...
        <React.Fragment>
            <div className='video-container'>
                <div className='video-text'>
                    <div className='video-title'>Confira nossos vídeos no YouTube</div>
                    <div className='video-description'>Alguns dos nossos conteúdos estão disponíveis no YouTube. Inscreva-se e explore nosso acervo de vídeos!</div>
                </div>
