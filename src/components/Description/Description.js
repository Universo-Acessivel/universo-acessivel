  ...
  return (
    <div id="sobreNos" className='description-container'>
        ...
        >
            ...
            os alunos do <a className="link-IBC" href="https://www.gov.br/ibc/pt-br" target='blank' referrerPolicy='noopener noreferrer' title='Acessar Instituto Benjamin Constant'>Instituto Benjamin Constant (IBC)</a>. No entanto, atingimos estudantes de todo o Brasil, 
