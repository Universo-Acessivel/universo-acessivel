  ...
  return (
    <div className='description-container'>
        <div className='project-description'>
            ...
            os alunos do <a className="link-IBC" href="https://www.gov.br/ibc/pt-br" target='blank' referrerPolicy='noopener noreferrer'>Instituto Benjamin Constant (IBC)</a>. No entanto, atingimos estudantes de todo o Brasil, 
